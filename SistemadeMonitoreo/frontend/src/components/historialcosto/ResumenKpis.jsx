// frontend/src/components/historialcosto/ResumenKpis.jsx
import React from "react";
import { Card, Col, Row } from "react-bootstrap";
import { FaCoins, FaWeight, FaDollarSign, FaClipboardList } from "react-icons/fa";
...
export default function ResumenKpis({ kpis }) {
  if (!kpis) return null;
    ...
    <Row className="g-3 mt-3">
      ...
      <Col md={3}>
        <KpiCard
          ...
          value={String(kpis.recolecciones || 0)}
